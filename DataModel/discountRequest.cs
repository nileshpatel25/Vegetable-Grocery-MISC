...
namespace apiGreenShop.DataModel
{
    public class discountRequest
    {
        ...
        public string menuspecific { get; set; }
        public string userspecifics { get; set; }
        public string conditionaldiscount { get; set; }
        public double mindiscountamt { get; set; }
        public string status { get; set; }
        public bool deleted { get; set; }
        public DateTime createdAt { get; set; }
        public List<DiscountMenuSpecific> discountMenuSpecifics { get; set; }
        public List<DiscountUserSpecific> discountUserSpecifics { get; set; }
    }
}